...
function PrimeiroUsuarioAdmin(){
    ...
    const handleSubmit = (event) => {
        ...
        axios.post("http://localhost:3000/criarPrimeiroUsuario", obj, {withCredentials: true})
        .then((response) => {
    ...
    return (
        <div className="container">
            <h3 className="userFormHeader">Entre com os dados do usuário administrador:</h3>
...
export default PrimeiroUsuarioAdmin;